...
const CreateInventoryModal = ({ userProfile, onCreated, onClose, showNotification }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 w-full max-w-lg relative">
        ...
        <h2 className="text-xl font-bold mb-4 text-indigo-700 dark:text-indigo-300">Create Inventory Item</h2>
